...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        toolbarSettings: {
            ...
            showDraftButton: true, // show/hide save draft button
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnDraft = this.options.toolbarSettings.showDraftButton !== false ? $('<button></button>').text(this.options.lang.draft).addClass('btn btn-default sw-btn-save-draft').attr('type', 'button') : null;
            var btnGroup = $('<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 push-lg-3"></div>').addClass('btn-group navbar-btn sw-btn-group' + this.options.toolbarSettings.toolbarButtonPosition).attr('role', 'group').append(btnPrevious, btnDraft, btnNext);

            // Add extra toolbar buttons
            var btnGroupExtra = null;

            if (this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0) {
                btnGroupExtra = $('<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 push-lg-3"></div>').addClass('btn-group navbar-btn sw-btn-group-extra-' + this.options.toolbarSettings.toolbarButtonPosition).attr('role', 'group');
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                case 'top':
                    ...
                    break;
                case 'bottom':
                    toolbarBottom = $('<nav></nav>').addClass('navbar btn-toolbar sw-toolbar sw-toolbar-bottom container');
        ...
        _setEvents: function () {
            ...
            $('.sw-btn-next', this.main).on("click", function (e) {
                ...
                if (mi.steps.index(this) !== mi.current_index) {
                  ...
                  if (mi.current_index == 4 )  {
                    $('.sw-btn-next').addClass('submit');
                    $('.sw-btn-next').text("SUBMIT APPLICATION");
                  }

                  if (mi.current_index == 5 )  {
                    $('.sw-btn-next').hide();
                    $('.sw-btn-prev').hide();
                    $('.sw-btn-save-draft').hide();
            ...
            $('.sw-btn-prev', this.main).on("click", function (e) {
                ...
                if (mi.steps.index(this) !== mi.current_index) {
                    mi._showPrevious();
                    if (mi.current_index !== 4 )  {
                      $('.sw-btn-next').removeClass('submit');
        ...
        _setButtons: function (idx) {
            ...
            if (!this.options.cycleSteps) {
                if (0 >= idx) {
                    ...
                    $('.sw-btn-save-draft', this.main).addClass("disabled");
                } else {
                    $('.sw-btn-prev', this.main).removeClass("disabled");
                    $('.sw-btn-save-draft', this.main).removeClass("disabled");
                }
